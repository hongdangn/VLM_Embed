...
# MODEL_NAME="./training/sft_meta_cls/checkpoint-epoch-0"
# OUTPUT_DIR="./eval-res"
...
torchrun --nproc_per_node=$NUM_GPUS_PER_NODE --master_port 30000 $TRAIN_SCRIPT \
    ...
    --pooling "eos" \
    --dataset_name "TIGER-Lab/MMEB-train" \
    --subset_name "OK-VQA" "A-OKVQA" "DocVQA" "InfographicsVA" "ChartQA" "Visual7W" \
    --dataset_split "original" \
    --model_backbone "llava_qwen2" \
    --image_dir "./vlm2vec_train/MMEB-train/" \
...
MODEL_NAME="./training/sft_meta_ret/checkpoint-epoch-0"
OUTPUT_DIR="./eval-res"
DATASET_NAME="TIGER-Lab/MMEB-eval"
IMAGE_DIR="./eval-data"
BATCH_SIZE=32
