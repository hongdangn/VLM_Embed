...
class ProposalLossWithDTW(nn.Module):
    ...
    def compute_ot_loss(self, student_qry_output, student_pos_output, teacher_qry_output, teacher_pos_output, distiller, input_data, topk_results):
        ...
        teacher_qry_reps, teacher_qry_hidden_states, teacher_qry_image_features, _ , teacher_qry_attention = teacher_qry_output
        teacher_pos_reps, teacher_pos_hidden_states, teacher_pos_image_features, _ , teacher_pos_attention = teacher_pos_output

        student_qry_reps, student_qry_hidden_states, student_qry_image_features, _ , student_qry_attention = student_qry_output
        student_pos_reps, student_pos_hidden_states, student_pos_image_features, _ , student_pos_attention = student_pos_output
